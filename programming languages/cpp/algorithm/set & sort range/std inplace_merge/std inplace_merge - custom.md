...
tags:
  ...
  - algorithm
---
[[programming languages/cpp/algorithm/set & sort range/std inplace_merge/_|<=]]
...
```
[original] {{name: Alice, age: 70}, {name: Bob, age: 75}, {name: Charlie, age: 80}, {name: Diana, age: 65}, {name: Eve, age: 85}}
[after] {{name: Diana, age: 65}, {name: Alice, age: 70}, {name: Bob, age: 75}, {name: Charlie, age: 80}, {name: Eve, age: 85}}
```
