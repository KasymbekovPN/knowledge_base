...
tags:
  ...
  - algorithm
---
[[programming languages/cpp/algorithm/set & sort range/std set_union/_|<=]]
...
    set_union(a.begin(), a.end(),
		      b.begin(), b.end(), back_inserter(result0));
...
    set_union(a.begin(), a.end(), 
			  b.begin(), b.end(),
			  back_inserter(result1), greater<int>());
...
[A] {1, 2, 3, 4, 5}
[B] {4, 5, 6, 7, 8}
[RESULT0] {1, 2, 3, 4, 5, 6, 7, 8}
[RESULT1] {8, 7, 6, 5, 4, 3, 2, 1}
```
