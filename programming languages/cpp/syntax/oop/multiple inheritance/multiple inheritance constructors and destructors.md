...
Стоит обратить внимание на порядок вызов конструкторов. В определении класса _Ebook_ первым базовым классом указан класс _File_, поэтому сначала вызываем конструктор класса _File_ и только потом конструктор класса _File_.
