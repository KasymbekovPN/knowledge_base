...
Для добавления элементов в вектор применяется функции _push_back_ и _emplace_back_.
- `push_cack` - добавляет копию объекта в конец (или обеспечивает перемещение, если возможно)
- `emplace_back` - создает объект в конце вектора без копирования или перемещения
